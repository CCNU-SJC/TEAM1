...
?>
   <div class="container body-content">
        <div class="panel panel-default">  
                <div class="panel-heading">确认反馈申请</div>  
                <div class="panel-body">  
                    <form class="form-inline" method="post">  
                        ...
                        <div class="row text-right" style="margin-top:20px;">  
                            <div class="col-sm-12">  
                                <button class="btn btn-primary" type=submit value="提交反馈" >提交反馈</button>  
                                <button class="btn btn-success" type="button"><a style='color:rgb(255, 255, 255)' href="user-approval.php">返 回</a></button>  
                            </div>  
                        </div>  
                    </form>  
                </div>  
